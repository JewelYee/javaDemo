 ...
 * @Desciption:
 * @Auther: yee
 * @Date:2020/10/20 6:54 PM
 */
@Service
public class KafkaConsumerFactory implements KafkaListenerConfigurer,BeanFactoryAware {
    ...
    private class KafkaHandlerMethodFactoryAdapter implements MessageHandlerMethodFactory {
        ...
        private MessageHandlerMethodFactory createDefaultMessageHandlerMethodFactory() {
            ...
            defaultFactory.setBeanFactory(KafkaConsumerFactory.this.beanFactory);

            ConfigurableBeanFactory cbf =
                    (KafkaConsumerFactory.this.beanFactory instanceof ConfigurableBeanFactory ?
                            (ConfigurableBeanFactory) KafkaConsumerFactory.this.beanFactory : null);
