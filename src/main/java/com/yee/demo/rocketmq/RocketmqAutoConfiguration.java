...
public class RocketmqAutoConfiguration {
    /**
     * defaultProducer用来发送普通消息、
     * transactionProducer用来发送事务消息
     * pushConsumer用来接收订阅的所有topic下的消息，并派发给不同的tag的消费者。
     */
    ...
    public DefaultMQProducer defaultProducer() throws MQClientException {
        ...
        producer.setInstanceName(properties.getProducer().getString("instanceName"));
